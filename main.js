...
if(parsed.lang === 'sv' || !parsed.lang) {
    ...
    yrgoP.textContent="During the course you learn everything you need to call your self a fullstack developer, which means that you will be able to work on all levels in an IT system and feel at home in both front-end, back-end, database and server environment."
    jensen.textContent="JENSEN - IT project management | sep. 2017 - jan. 2019"
    jensenP.textContent="The course contains classes in leadership and project management methodology as well as technical courses in E-commerce, system development and mobile development."
    ...
    villaP.textContent="At Villa Belparc I worked with many different tasks. I worked as a waiter, bartender, cashier and was responsible for the opening and closing of the restaurant."
